...
import ConfirmIconButton from './button/ConfirmIconButton.vue'
import CancelIconButton from './button/CancelIconButton.vue'
import UploadIconButton from './button/UploadIconButton.vue'
...
import BaseChip from './chip/BaseChip.vue'
import SelectedChip from './chip/SelectedChip.vue'
...
import BarcodeDialog from './dialog/BarcodeDialog.vue'
...
export default {
  install (app) {
    ...
    app.component('ConfirmIconButton', ConfirmIconButton)
    app.component('CancelIconButton', CancelIconButton)
    app.component('UploadIconButton', UploadIconButton)
    ...
    app.component('SelectedChip', SelectedChip)
    ...
    app.component('BarcodeDialog', BarcodeDialog)
