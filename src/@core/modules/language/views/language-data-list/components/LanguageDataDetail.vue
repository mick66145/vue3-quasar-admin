  ...
  <base-page>
    ...
    <base-form ref="form">
      <div class="row q-col-gutter-md">
        <div class="col-12" v-show="currentBlock === 'languageDataInfo'">
          <q-card>
            <card-header>
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.field-label')} *`">
                    <input-text v-model="formData.label" class="full-width" :label="`${$t('g.common.field-label')}`"
                      :placeholder="$t('g.common.input', { field: $t('g.common.field-label') })" required />
                  </base-form-item>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.data-key')} *`">
                    <input-text v-model="formData.data_key" class="full-width" :label="`${$t('g.common.data-key')}`"
                      :placeholder="$t('g.common.input', { field: $t('g.common.data-key') })" required />
                  </base-form-item>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.i18n-key')} *`">
                    <input-text v-model="formData.i18n_key" class="full-width" :label="`${$t('g.common.i18n-key')}`"
                      :placeholder="$t('g.common.input', { field: $t('g.common.i18n-key') })" required />
                  </base-form-item>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.placeholder')}`">
                    <input-text v-model="formData.placeholder" class="full-width"
                ...
                <div class="col-12">
                  <base-form-item :label="`${$t('g.common.value')}`">
                    <component v-model="formData.value" :is="formData.component" :label="observeLabel"
        ...
        <div class="col-12" v-show="currentBlock === 'fieldeSetting'">
          <q-card>
            <card-header>
            ...
            <card-body class="q-pt-none">
              <div class="row q-col-gutter-xs">
                <div class="col-12">
                  <input-checkbox v-model="formData.required" class="full-width" :label="`${$t('g.common.required')}`"
                    :placeholder="$t('g.common.input', { field: $t('g.common.required') })" />
                </div>
                <div class="col-12">
                  <input-checkbox v-model="formData.disable" class="full-width" :label="`${$t('g.common.disable')}`"
                    :placeholder="$t('g.common.input', { field: $t('g.common.disable') })" />
                </div>
                <div class="col-12">
                  <input-checkbox v-model="formData.readonly" class="full-width" :label="`${$t('g.common.readonly')}`"
                    :placeholder="$t('g.common.input', { field: $t('g.common.readonly') })" />
                </div>
                <div class="col-12">
                  <input-checkbox v-model="formData.is_show" class="full-width" :label="`${$t('g.common.is-show')}`"
        ...
        <div class="col-12" v-show="currentBlock === 'fieldWidthSetting'">
          <q-card>
            <card-header>
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.layout-xs')}`">
                    <input-number v-model="formData.layout.xs" class="full-width"
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.layout-sm')}`">
                    <input-number v-model="formData.layout.sm" class="full-width" :label="`${$t('g.common.layout-sm')}`"
                      :placeholder="$t('g.common.input', { field: $t('g.common.layout-sm') })" />
                  </base-form-item>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.layout-md')}`">
                    <input-number v-model="formData.layout.md" class="full-width" :label="`${$t('g.common.layout-md')}`"
                      :placeholder="$t('g.common.input', { field: $t('g.common.layout-md') })" />
                  </base-form-item>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.layout-lg')}`">
                    <input-number v-model="formData.layout.lg" class="full-width" :label="`${$t('g.common.layout-lg')}`"
                      :placeholder="$t('g.common.input', { field: $t('g.common.layout-lg') })" />
                  </base-form-item>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
                  <base-form-item :label="`${$t('g.common.layout-xl')}`">
                    <input-number v-model="formData.layout.xl" class="full-width" :label="`${$t('g.common.layout-xl')}`"
