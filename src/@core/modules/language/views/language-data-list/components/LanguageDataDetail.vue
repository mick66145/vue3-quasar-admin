  ...
  <base-page>
    ...
    <base-form ref="form">
      <div class="row q-col-gutter-md">
        <div v-show="currentBlock === 'languageDataInfo'" class="col-12">
          <q-card>
            <card-header>
        ...
        <div v-show="currentBlock === 'fieldeSetting'" class="col-12">
          <q-card>
            <card-header>
        ...
        <div v-show="currentBlock === 'fieldWidthSetting'" class="col-12">
          <q-card>
            <card-header>
